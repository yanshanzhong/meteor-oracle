...
OracleCollection.prototype.update = function(selector, modifier, options, callback) {
	...
	console.log("UPDATE: ", selector, modifier, options);
	...
	if(modifier && modifier["."]) {
		...
		result = self.db.executeCommand(sql, sqlParameters, self.oracleOptions);

		console.log("UPDATE SQL", sql, sqlParameters);
