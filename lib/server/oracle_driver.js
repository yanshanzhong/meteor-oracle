...
OracleConnection.resetDefaultOracleOptions = function(oracleOptions) {
...
OracleConnection.setDefaultOracleOptions = function(oracleOptions) {
	OracleConnection._defaultOracleOptions = OracleConnection._mergeOptions(oracleOptions, OracleConnection._defaultOracleOptions);
};

OracleConnection.getDefaultOracleOptions = function() {
	var ret = EJSON.clone(OracleConnection._defaultOracleOptions);
